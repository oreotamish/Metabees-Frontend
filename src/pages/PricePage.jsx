...
function PricePage() {
  ...
  if (!getCookieInfo()) {
    return (
      <div className="text-white mt-40 flex flex-col justify-center items-center ">
        <p className="text-purple-500 text-4xl"> You have login/sign to view this page </p>
        <button className="button1 m-3" onClick={()=>window.location.href='/login'}>login</button>
        <button className="button1 m-3" onClick={()=>window.location.href='/signup'}>signup</button>
      </div>
    );
  }
  return (

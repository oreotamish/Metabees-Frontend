  ...
  if (!getCookieInfo()) {
    ...
    return (
      <div className="text-white mt-40 flex flex-col justify-center items-center ">
        <p className="text-purple-500 text-4xl price-heading">
          {' '}
          You Have To Login or SignUp To View This Page{' '}
        </p>
        <button class="price-login-btn mt-24" type="button" onClick={onClick}>
          <strong>Continue!</strong>
          <div id="price-container-stars">

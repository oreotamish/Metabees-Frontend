    ...
    <section className="relative overflow-x-hidden bg-[#1a0525] w-full mt-8 mb-0 sm:flex-col">
      <div className="container relative z-10 mx-auto px-4">
        <div className=" flex flex-wrap items-center justify-between">
          ...
          <div className="w-auto p-8">
            <ul className="-m-5 flex flex-wrap items-center max-sm:flex-col max-sm:-m-10">
              <li className="p-5">
                <a
          ...
          <div className="w-auto p-8">
            <div className="-m-1.5 flex flex-wrap ">
              <div className="w-auto p-1.5">
                <a href="#">
                  <div className="flex h-8 w-8 items-center justify-center rounded-full border border-gray-300 hover:border-[#19A7CE]">
                    <svg
                      width="8"
                      height="14"
                      viewBox="0 0 8 14"

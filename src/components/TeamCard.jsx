...
const TeamCard = (props) => {
  return (
    <div className="team-card">
      <div className="team-card-photo"></div>
      <div className="team-card-title">
        {props.name} <br />
        <span>{props.role}</span>
      </div>
      <div className="team-card-socials">
        <a href={props.facebooklink} target="blank">
          <button className="team-card-socials-btn team-facebook">
            <svg
              data-name="Layer 21"
              height="24"
              id="Layer_21"
        ...
        <a href={props.githublink} target="blank">
          <button className="team-card-socials-btn team-github">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="33"
              height="33"
